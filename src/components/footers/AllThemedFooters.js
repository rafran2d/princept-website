...
export const Footer = ({ variant = 'default', settings, ...rest }) => {
  return (
      <div>
        {settings?.showMap && (
            <MapSection
...
// 🎯 Default Footer - Clean and professional
      ...
      <footer className="bg-white border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div>
            <div className="mb-4">
              ...
              <span
                className={`text-xl font-bold ${settings?.logoUrl ? 'hidden' : 'block'}`}
            ...
            <SocialLinks
              customStyles={true}
              linkClassName="w-10 h-10 bg-gray-100 text-gray-700 hover:bg-gray-200 hover:text-gray-900 rounded-full flex items-center justify-center transition-all duration-200"
            />
          </div>

          {/* Navigation Links - Modern Style - CENTER */}
          <div>
            <h4 className="font-semibold text-gray-900 mb-4 text-center">Navigation</h4>
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-3 shadow-inner">
              <div className="grid grid-cols-2 gap-2">
                {navigationItems?.map((item, index) => (
                  <button
                    key={index}
                    onClick={() => scrollToSection?.(item.type, item.sectionId)}
                    className="flex items-center space-x-2 p-2 bg-white/70 rounded-xl hover:bg-white hover:shadow-sm transition-all duration-200 text-left group"
                  >
                    <div className="w-6 h-6 rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all duration-200 flex-shrink-0"
                         style={{ background: `linear-gradient(135deg, var(--color-primary), var(--color-secondary))` }}>
                      <div className="w-1.5 h-1.5 bg-white rounded-full"></div>
                    </div>
                    <span className="text-xs font-medium text-gray-700 transition-colors truncate group-hover:text-gray-700"
              ...
              <div className="mt-3 pt-3 border-t border-gray-200">
                <a
                  href="/admin"
                  className="w-full flex items-center justify-center space-x-2 py-2 text-white rounded-xl transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02] group"
                  style={{ background: `linear-gradient(135deg, var(--color-primary), var(--color-secondary))` }}
          ...
          {/* Contact Info - Modern Style like Office Hours */}
          <div>
            <h4 className="font-semibold text-gray-900 mb-4 text-center">Contact</h4>
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-3 shadow-inner">
              <div className="space-y-2">
                {settings?.email && (
                  <div className="flex items-center space-x-3 p-2 bg-white/70 rounded-xl hover:bg-white hover:shadow-sm transition-all duration-200">
                    <div className="w-8 h-8 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center shadow-md">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <a href={`mailto:${settings.email}`} className="text-sm font-medium text-gray-700 transition-colors"
                       onMouseEnter={(e) => e.target.style.color = 'var(--color-primary)'}
                       onMouseLeave={(e) => e.target.style.color = ''}>
                      {settings.email}
                    </a>
                ...
                {settings?.phone && (
                  <div className="flex items-center space-x-3 p-2 bg-white/70 rounded-xl hover:bg-white hover:shadow-sm transition-all duration-200">
                    ...
                    <a href={`tel:${settings.phone}`} className="text-sm font-medium text-gray-700 transition-colors"
                       onMouseEnter={(e) => e.target.style.color = 'var(--color-primary)'}
                       onMouseLeave={(e) => e.target.style.color = ''}>
                      {settings.phone}
                    </a>
                ...
                {settings?.address && (
                  <div className="flex items-start space-x-3 p-2 bg-white/70 rounded-xl hover:bg-white hover:shadow-sm transition-all duration-200">
                    <div className="w-8 h-8 bg-gradient-to-br from-purple-400 to-purple-600 rounded-xl flex items-center justify-center shadow-md flex-shrink-0">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-200 pt-6">
          <p className="text-gray-500 text-sm text-center md:text-left">
            {settings?.copyrightText || `© ${new Date().getFullYear()} ${settings?.siteName || settings?.logoText || ''}. Tous droits réservés.`}
          </p>
        </div>
      </div>
    </footer>
