...
const ImageUpload = ({ 
  ...
  const handleFileSelect = (file) => {
    ...
    reader.onload = (e) => {
      ...
      // Vérifier la taille du base64 (approximativement 4/3 de la taille du fichier)
      const estimatedBase64Size = base64.length;
      const maxBase64Size = 16 * 1024 * 1024; // 16MB limite pour base64
      
      if (estimatedBase64Size > maxBase64Size) {
        alert('L\'image est trop volumineuse après conversion. Veuillez utiliser une image plus petite.');
        return;
      }
