...
const CTASectionEditable = ({ section, useGlobalStyles, isEditing = false }) => {
    ...
    >
      ...
      <div className={`${isTheme('slack') ? 'w-full px-6 max-w-5xl mx-auto' : 'container mx-auto px-6'} relative z-10`}>
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            {isEditing ? (
              <EditableTitle
                ...
                placeholder="Titre de votre Call to Action"
                tag="h2"
              />
            ) : (
              <h2 className={`${
          ...
          {(buttonText || buttonLink || isEditing) && (
...
export default CTASectionEditable;
