        ...
        <div className="flex items-center justify-between px-8 py-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="group relative flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 overflow-hidden"
            >
            ...
            <Link
              to="/fr"
              target="_blank"
              className="group relative flex items-center space-x-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 overflow-hidden"
            >
...
const AdminLayout = () => {
  ...
  try {
    console.log('🏗️ AdminLayout - Tentative de chargement AdminThemeProvider');
    return (
      <AdminThemeProvider>
        <AdminLayoutContent />
      </AdminThemeProvider>
