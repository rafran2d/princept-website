...
const SectionCard = ({ section, onToggle, onDelete, onDuplicate, dragListeners }) => {
  ...
  const getSectionTypeColor = (type) => {
    const colors = {
      ...
      'hero-slider': 'bg-indigo-100 text-indigo-700',
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center py-12">
          ...
          <p className="admin-text-secondary">Chargement des sections...</p>
        </div>
      </div>
    );
  }

  // Afficher le message de création seulement si le chargement est terminé et qu'il n'y a vraiment aucune section
