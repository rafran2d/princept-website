...
const SiteSettings = () => {
  const { settings, updateSettings, updateNestedSetting, resetToDefaults, applyMetaUpdates, exportSettings, importSettings } = useSiteSettings();
  ...
  const tabs = [
    ...
    { id: 'email', label: 'Configuration Email', icon: Send },
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <p className="admin-text-muted text-sm mt-1">
                        ...
                        {activeTab === 'email' && 'Configuration SMTP et templates email'}
              ...
              <div className="space-y-8">
                ...
                <div className="admin-card p-6 rounded-lg shadow" style={{ borderColor: 'var(--admin-border)' }}>
                  ...
                  <p className="admin-text-secondary text-sm mb-6">
                    Choisissez votre méthode d'envoi d'emails préférée.
                  </p>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div 
                      ...
                      onClick={() => handleNestedChange('emailConfig.provider', 'smtp')}
                    >
                      <div className="flex items-center mb-2">
                        <input
                          type="radio"
                          name="emailProvider"
                          checked={settings.emailConfig?.provider === 'smtp'}
                          onChange={() => handleNestedChange('emailConfig.provider', 'smtp')}
                          className="mr-3"
                        />
                        <h4 className="font-semibold admin-text-primary text-sm">SMTP</h4>
                      </div>
                      <p className="text-xs admin-text-secondary">
                        Gmail, Outlook (simulation)
                      </p>
                    </div>
                    ...
                    <div 
                      ...
                      onClick={() => handleNestedChange('emailConfig.provider', 'emailjs')}
                    >
                      <div className="flex items-center mb-2">
                        <input
                          type="radio"
                          name="emailProvider"
                          checked={settings.emailConfig?.provider === 'emailjs'}
                          onChange={() => handleNestedChange('emailConfig.provider', 'emailjs')}
                          className="mr-3"
                        />
                        <h4 className="font-semibold admin-text-primary text-sm">EmailJS</h4>
                        <span className="ml-2 px-2 py-1 bg-green-600 text-white text-xs rounded">RÉEL</span>
                      </div>
                      <p className="text-xs admin-text-secondary">
                        Service frontend, facile
                      </p>
                    </div>

                    <div 
                      className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${
                        settings.emailConfig?.provider === 'mailjet' 
                          ? 'border-green-500 bg-green-50' 
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                      onClick={() => handleNestedChange('emailConfig.provider', 'mailjet')}
                    >
                      <div className="flex items-center mb-2">
                        <input
                          type="radio"
                          name="emailProvider"
                          checked={settings.emailConfig?.provider === 'mailjet'}
                          onChange={() => handleNestedChange('emailConfig.provider', 'mailjet')}
                          className="mr-3"
                        />
                        <h4 className="font-semibold admin-text-primary text-sm">Mailjet</h4>
                        <span className="ml-2 px-2 py-1 bg-green-600 text-white text-xs rounded">RÉEL</span>
                      </div>
                      <p className="text-xs admin-text-secondary">
                        API professionnelle
                    ...
                    <div 
                      className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${
                        settings.emailConfig?.provider === 'api' 
                          ? 'border-green-500 bg-green-50' 
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                      onClick={() => handleNestedChange('emailConfig.provider', 'api')}
                    >
                      <div className="flex items-center mb-2">
                        <input
                          type="radio"
                          name="emailProvider"
                          checked={settings.emailConfig?.provider === 'api'}
                          onChange={() => handleNestedChange('emailConfig.provider', 'api')}
                          className="mr-3"
                        />
                        <h4 className="font-semibold admin-text-primary text-sm">API Backend</h4>
                        <span className="ml-2 px-2 py-1 bg-green-600 text-white text-xs rounded">RÉEL</span>
                      </div>
                      <p className="text-xs admin-text-secondary">
                        Votre serveur
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleNestedChange('emailConfig.smtpHost', e.target.value)}
                        className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        style={{ borderColor: 'var(--admin-border)' }}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleNestedChange('emailConfig.smtpPort', parseInt(e.target.value))}
                        className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        style={{ borderColor: 'var(--admin-border)' }}
                        placeholder="587"
                      />
                      <p className="text-xs admin-text-muted mt-1">Port 587 (TLS) ou 465 (SSL) recommandé</p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleNestedChange('emailConfig.smtpUser', e.target.value)}
                        className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        style={{ borderColor: 'var(--admin-border)' }}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleNestedChange('emailConfig.smtpPassword', e.target.value)}
                        className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        style={{ borderColor: 'var(--admin-border)' }}
                        placeholder="••••••••"
                      />
                      <p className="text-xs admin-text-muted mt-1">Utilisez un mot de passe d'application pour Gmail</p>
                    </div>
                  </div>
                    ...
                    <div className="mt-6 flex items-center">
                      <input
                        ...
                        onChange={(e) => handleNestedChange('emailConfig.smtpSecure', e.target.checked)}
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                      />
                      <label htmlFor="smtpSecure" className="ml-2 text-sm admin-text-secondary">
                ...
                {settings.emailConfig?.provider === 'mailjet' && (
                  <div className="admin-card p-6 rounded-lg shadow" style={{ borderColor: 'var(--admin-border)' }}>
                    ...
                    <p className="admin-text-secondary text-sm mb-6">
                      Configurez vos clés API Mailjet. Vous pouvez les obtenir dans votre{' '}
                      <a 
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          value={settings.emailConfig?.mailjetApiKey || ''}
                          onChange={(e) => handleNestedChange('emailConfig.mailjetApiKey', e.target.value)}
                          className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          style={{ borderColor: 'var(--admin-border)' }}
                          placeholder="votre-cle-api-mailjet"
                        />
                        <p className="text-xs admin-text-muted mt-1">Clé publique de votre compte Mailjet</p>
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          type="password"
                          value={settings.emailConfig?.mailjetSecretKey || ''}
                          onChange={(e) => handleNestedChange('emailConfig.mailjetSecretKey', e.target.value)}
                          className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          style={{ borderColor: 'var(--admin-border)' }}
                          placeholder="votre-cle-secrete-mailjet"
                        />
                        <p className="text-xs admin-text-muted mt-1">Clé privée de votre compte Mailjet</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 flex items-center">
                      <input
                        type="checkbox"
                        id="mailjetSandbox"
                        checked={settings.emailConfig?.mailjetSandboxMode || false}
                        onChange={(e) => handleNestedChange('emailConfig.mailjetSandboxMode', e.target.checked)}
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                      />
                      <label htmlFor="mailjetSandbox" className="ml-2 text-sm admin-text-secondary">
                        Mode Sandbox (pour les tests - emails non envoyés réellement)
                      </label>
                    </div>

                    <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <h4 className="text-sm font-medium text-blue-900 mb-2">💡 Avantages de Mailjet</h4>
                      <ul className="text-sm text-blue-800 space-y-1">
                        <li>• Livraison garantie et suivi des emails</li>
                        <li>• Statistiques détaillées (ouvertures, clics)</li>
                        <li>• Gestion automatique des rebonds</li>
                        <li>• Support de la personnalisation avancée</li>
                      </ul>
                    </div>
                  </div>
                )}
                ...
                {settings.emailConfig?.provider === 'emailjs' && (
                  <div className="admin-card p-6 rounded-lg shadow" style={{ borderColor: 'var(--admin-border)' }}>
                    ...
                    <p className="admin-text-secondary text-sm mb-6">
                      EmailJS permet l'envoi d'emails directement depuis le frontend. Créez un compte sur{' '}
                      <a 
                      ...
                      >
                        emailjs.com
                      </a> et configurez un service email.
                    </p>
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => handleNestedChange('emailConfig.emailjsServiceId', e.target.value)}
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            style={{ borderColor: 'var(--admin-border)' }}
                            placeholder="service_xxxxxxx"
                          />
                          <p className="text-xs admin-text-muted mt-1">ID de votre service EmailJS</p>
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => handleNestedChange('emailConfig.emailjsTemplateId', e.target.value)}
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            style={{ borderColor: 'var(--admin-border)' }}
                            placeholder="template_bxltl6i"
                          />
                          <p className="text-xs admin-text-muted mt-1">ID de votre template EmailJS unique</p>
                        </div>
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            onChange={(e) => handleNestedChange('emailConfig.emailjsPublicKey', e.target.value)}
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            style={{ borderColor: 'var(--admin-border)' }}
                            placeholder="votre-cle-publique"
                          />
                          <p className="text-xs admin-text-muted mt-1">Clé publique de votre compte EmailJS</p>
                        </div>
                      </div>
                    ...
                    <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
                      <h4 className="text-sm font-medium text-green-900 mb-2">✅ Configuration EmailJS</h4>
                      <div className="text-sm text-green-800 space-y-1">
                        <p>1. Créez un compte sur emailjs.com</p>
                        <p>2. Connectez votre service email (Gmail, Outlook, etc.)</p>
                        <p>3. Créez un template avec les variables : from_name, from_email, subject, message</p>
                        <p>4. Copiez vos IDs dans les champs ci-dessus</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {settings.emailConfig?.provider === 'api' && (
                  <div className="admin-card p-6 rounded-lg shadow" style={{ borderColor: 'var(--admin-border)' }}>
                    ...
                    <p className="admin-text-secondary text-sm mb-6">
                      Configurez l'endpoint de votre API backend pour l'envoi d'emails.
                    </p>
                    ...
                    <div>
                      ...
                      <input
                        type="url"
                        value={settings.emailConfig?.apiEndpoint || ''}
                        onChange={(e) => handleNestedChange('emailConfig.apiEndpoint', e.target.value)}
                        className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        style={{ borderColor: 'var(--admin-border)' }}
                        placeholder="/api/send-email ou https://mon-api.com/send-email"
                      />
                      <p className="text-xs admin-text-muted mt-1">URL de votre endpoint d'envoi d'email</p>
                    </div>

                    <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                      <h4 className="text-sm font-medium text-yellow-900 mb-2">⚙️ Backend requis</h4>
                      <p className="text-sm text-yellow-800">
                        Cette option nécessite un serveur backend. Voir la documentation pour créer l'API.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleNestedChange('emailConfig.senderEmail', e.target.value)}
                        className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        style={{ borderColor: 'var(--admin-border)' }}
                        placeholder="noreply@exemple.com"
                      />
                      <p className="text-xs admin-text-muted mt-1">Email qui apparaîtra comme expéditeur</p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleNestedChange('emailConfig.senderName', e.target.value)}
                        className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        style={{ borderColor: 'var(--admin-border)' }}
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleNestedChange('emailConfig.replyToEmail', e.target.value)}
                        className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        style={{ borderColor: 'var(--admin-border)' }}
                        placeholder="contact@exemple.com"
                      />
                      <p className="text-xs admin-text-muted mt-1">Email vers lequel les réponses seront dirigées</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="border rounded-lg p-6 admin-bg-tertiary">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            type="text"
                            value={getStringValue(settings.emailConfig?.templates?.contact?.subject)}
                            onChange={(e) => handleNestedChange('emailConfig.templates.contact.subject', e.target.value)}
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            style={{ borderColor: 'var(--admin-border)' }}
                        ...
                        <div>
                          ...
                          <textarea
                            value={getStringValue(settings.emailConfig?.templates?.contact?.template)}
                            onChange={(e) => handleNestedChange('emailConfig.templates.contact.template', e.target.value)}
                            rows={8}
                    ...
                    <div className="border rounded-lg p-6 admin-bg-tertiary">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            type="text"
                            value={getStringValue(settings.emailConfig?.templates?.contactConfirmation?.subject)}
                            onChange={(e) => handleNestedChange('emailConfig.templates.contactConfirmation.subject', e.target.value)}
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            style={{ borderColor: 'var(--admin-border)' }}
                        ...
                        <div>
                          ...
                          <textarea
                            value={getStringValue(settings.emailConfig?.templates?.contactConfirmation?.template)}
                            onChange={(e) => handleNestedChange('emailConfig.templates.contactConfirmation.template', e.target.value)}
                            rows={8}
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm"
                            style={{ borderColor: 'var(--admin-border)' }}
                            disabled={!settings.emailConfig?.templates?.contactConfirmation?.enabled}
                    ...
                    <div className="border rounded-lg p-6 admin-bg-tertiary">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            type="text"
                            value={getStringValue(settings.emailConfig?.templates?.newsletter?.subject)}
                            onChange={(e) => handleNestedChange('emailConfig.templates.newsletter.subject', e.target.value)}
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            style={{ borderColor: 'var(--admin-border)' }}
                        ...
                        <div>
                          ...
                          <textarea
                            value={getStringValue(settings.emailConfig?.templates?.newsletter?.template)}
                            onChange={(e) => handleNestedChange('emailConfig.templates.newsletter.template', e.target.value)}
                            rows={6}
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm"
                            style={{ borderColor: 'var(--admin-border)' }}
                            disabled={!settings.emailConfig?.templates?.newsletter?.enabled}
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  <h4 className="text-sm font-medium text-blue-900 mb-3">💡 Guide de configuration</h4>
                  <div className="text-sm text-blue-800 space-y-2">
                    {settings.emailConfig?.provider === 'mailjet' ? (
                      <>
                        <p><strong>Mailjet :</strong> Créez un compte sur mailjet.com, obtenez vos clés API dans la section "Account Settings > API Keys".</p>
                        <p><strong>Sandbox :</strong> Activez le mode sandbox pour tester sans envoyer d'emails réels.</p>
                        <p><strong>Domaine :</strong> Vérifiez votre domaine dans Mailjet pour améliorer la délivrabilité.</p>
                      </>
                    ) : (
                      <>
                        <p><strong>Gmail :</strong> smtp.gmail.com, port 587, activez l'authentification à 2 facteurs et utilisez un mot de passe d'application.</p>
                        <p><strong>Outlook :</strong> smtp-mail.outlook.com, port 587, TLS activé.</p>
                      </>
                    )}
