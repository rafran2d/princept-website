            ...
            {editingLanguage && editingLanguage.id === language.id ? (
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="text-2xl">
                        {getCorrectFlag(editingLanguage.flag, editingLanguage.code)}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4">
                <div className="flex items-center space-x-4">
                  <div className="text-2xl" title={`Drapeau ${language.name}`}>
                    {getCorrectFlag(language.flag, language.code)}
                  </div>
                  <div>
                    <div className="flex items-center space-x-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <div className="text-2xl">
                  {getCorrectFlag(newLanguage.flag, newLanguage.code)}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-10 gap-2">
              {commonFlags.map((flag, index) => (
                <button
                  ...
                  type="button"
                >
                  {isValidEmoji(flag) ? flag : getFlagFromCode(flag)}
                </button>
              ))}
            </div>
          </div>
